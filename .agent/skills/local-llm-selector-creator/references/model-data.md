# Справочник и схема данных локальных LLM

## Схема JSON для базы моделей
При создании базы данных в проекте (например, `data/models.json`), используйте следующую структуру:
...
interface ModelData {
  ...
  capabilities: {
    reasoning: "Basic" | "Advanced" | "Excellent";
    coding: "Basic" | "Advanced" | "Excellent";
  };
  benchmarks: {
    mmlu_pro?: number;
    ifeval?: number;
...
Используйте этот набор данных для инициализации приложения. Значения контекста (Context Window) обновлены согласно требованиям.
